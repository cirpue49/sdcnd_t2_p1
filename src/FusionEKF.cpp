...
void FusionEKF::ProcessMeasurement(const MeasurementPackage &measurement_pack) {
  ...
  if (!is_initialized_) {
    ...
    */
    ...
    if(measurement_pack.raw_measurements_(0) == 0 and measurement_pack.sensor_type_ == MeasurementPackage::LASER){
      return;
    }
    ...
    cout << "initialised x"<<endl <<ekf_.x_ << endl;
  ...
  cout << "Time difference "<< dt <<"s"<< endl;
  cout << "orevious Time "<< previous_timestamp_ <<"s"<< endl;
  previous_timestamp_ = measurement_pack.timestamp_;
  cout << "orevious Time "<< previous_timestamp_ <<"s"<< endl;
  float dt_2 = dt * dt;
  float dt_3 = dt_2 * dt;
